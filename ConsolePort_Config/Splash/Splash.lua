...
local DISCORD_LINK, DISCORD_TEXT = 'https://discord.gg/AWeHd48',
	'尋求支援、討論玩法、分享想法，以及找到志同道合玩家的社群。' ..
	'\n\n點這裡加入伺服器。'
local PATREON_LINK, PATREON_TEXT = 'https://www.patreon.com/consoleport',
	'雖然開發和更新這個插件需要花很多的時間和努力，ConsolePort 仍會永久提供免費使用。' ..
	'\n\n在 Patreon 網站成為贊助者以解鎖你的 Discord 天賦，進而支持這個開發專案的未來。' ..
	'\n\n點這裡成為贊助者。'
...
local function ShowExternalLink(name, link)
	CPAPI.Popup('ConsolePort_External_Link', {
		text = L('連結到 %s。\n按 Ctrl+A 全選，然後按 Ctrl+C 複製。\n\n在網頁瀏覽器 (Ctrl+V) 貼上連結。', name);
		button1 = CLOSE;
		showAlert = true;
		timeout = 0;
		whileDead = true;
						...
						_Point = {'TOP', '$parent.Help', 'BOTTOM', 0, -FIXED_OFFSET * 2};
						{
							Discord = {
								...
								_OnLoad = function(self)
									...
									self:AddTooltipLine('加入 Discord')
							...
							Patreon = {
								...
								_OnLoad = function(self)
									...
									self:AddTooltipLine('Patreon 贊助')
