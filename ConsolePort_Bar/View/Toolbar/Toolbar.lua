...
function Eye:OnShowAll(showAll)
	...
	self.title = showAll and '隱藏彈出按鈕' or '顯示彈出按鈕';
end
...
function Config:OnEvent()
	...
	self.error = InCombatLockdown() and '戰鬥中無法打開設定選項。' or nil;
end
